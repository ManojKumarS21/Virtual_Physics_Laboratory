    ...
    return (
        <>
            <button
                ...
                className="absolute bottom-28 right-4 flex items-center gap-2 bg-black/70 backdrop-blur-xl px-4 py-2.5 rounded-xl border border-white/10 shadow-xl text-white hover:bg-white/10 transition-all z-20"
            >
                ...
                {isOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-[#111111] border border-white/10 p-8 rounded-3xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto"
                        ...
                        >
                            ...
                            <div className="space-y-6">
                                <section>
                                    <h2 className="text-blue-400 font-bold uppercase tracking-widest text-xs mb-2">Principle</h2>
                                ...
                                <section>
                                    <h2 className="text-blue-400 font-bold uppercase tracking-widest text-xs mb-2">Formula</h2>
                                ...
                                <section>
                                    <h2 className="text-blue-400 font-bold uppercase tracking-widest text-xs mb-2">Circuit Diagram</h2>
                                ...
                                <section>
                                    <h2 className="text-blue-400 font-bold uppercase tracking-widest text-xs mb-2">Procedure</h2>
